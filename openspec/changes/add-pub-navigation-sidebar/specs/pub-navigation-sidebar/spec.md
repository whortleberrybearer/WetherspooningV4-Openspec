# Specification: Pub Navigation Sidebar

**Capability ID:** `pub-navigation-sidebar`  
**Version:** 1.0.0  
**Status:** Draft  
...
The Pub Navigation Sidebar capability provides a hierarchical, browsable interface for discovering and navigating to Wetherspoons pub locations, complementing the visual map interface.
...
### pub-locations-map
The sidebar integrates with the existing map capability by:
- Sharing the same pub data source (REQ-PLM-003)
- Triggering map pan/zoom operations on pub selection
- Using the existing info window display (REQ-PLM-004)
- Maintaining responsive design principles (REQ-PLM-005)

## Data Requirements

### Pub Data Structure
Reuses existing pub data structure from `pub-locations-map`:
- `id` (number, required)
...
- Additional fields as defined in REQ-PLM-003

## UI Specifications

### Sidebar Dimensions
- Desktop: 320px width (md: 384px)
- Mobile: 80% of viewport width, max 320px
- Height: 100vh (full viewport height)

### Z-Index Layering
- Burger menu button: z-60
- Sidebar: z-50
