...
This delta creates a new capability for the PubDetailSheet component that allows users to capture visit details including rating and notes.

## Purpose
The PubDetailSheet provides a dialog interface for users to create and update pub visit records, including optional visit date, rating (1-5 stars), and personal notes.
