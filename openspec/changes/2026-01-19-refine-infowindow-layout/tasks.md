...
- [ ] **Task 1.1**: Create CustomPubOverlay class file
...
- [ ] **Task 1.2**: Implement OverlayView lifecycle methods
...
- [ ] **Task 1.3**: Implement positioning logic
...
- [ ] **Task 2.1**: Create content generation method
...
- [ ] **Task 2.2**: Add close button to content
...
- [ ] **Task 2.3**: Update styling for fixed widths
...
- [ ] **Task 3.1**: Implement event listener attachment
...
- [ ] **Task 3.2**: Implement event listener cleanup
...
- [ ] **Task 3.3**: Add keyboard event handling
...
- [ ] **Task 4.1**: Implement show() method
...
- [ ] **Task 5.1**: Import and initialize CustomPubOverlay
...
- [ ] **Task 5.2**: Update showPubInfo() function
...
- [ ] **Task 5.3**: Update overlay when theme changes
...
- [ ] **Task 5.4**: Update overlay when visit data changes
...
- [ ] **Task 5.5**: Update handlePubSelect() function
...
- [ ] **Task 6.1**: Add dialog ARIA attributes
...
- [ ] **Task 6.2**: Implement focus management
...
- [ ] **Task 6.3**: Test keyboard navigation
...
- [ ] **Task 7.1**: Test responsive widths
...
- [ ] **Task 7.2**: Test viewport boundary detection
...
- [ ] **Task 7.3**: Test overlay positioning on map interactions
...
- [ ] **Task 7.4**: Test overlay lifecycle
...
- [ ] **Task 7.5**: Test all content rendering
...
- [ ] **Task 7.6**: Test theme integration
...
- [ ] **Task 7.8**: Fix any visual or functional issues
...
- [ ] **Task 8.1**: Remove old InfoWindow code
...
- [ ] **Task 8.3**: Update any relevant documentation
...
- [ ] Overlay displays at correct position above marker
- [ ] Overlay has fixed width: 400px desktop, 320px mobile, 280px very small
- [ ] Overlay never exceeds viewport width
- [ ] Close button positioned in top-right without blank space
- [ ] Close button closes overlay
- [ ] ESC key closes overlay
- [ ] Track visit button opens PubDetailSheet (authenticated)
- [ ] Sign in button opens LoginDialog (unauthenticated)
- [ ] All badges render correctly (status, visit, location, rating)
- [ ] Notes preview displays when available
- [ ] Website link opens in new tab
- [ ] Overlay repositions on map pan
- [ ] Overlay repositions on map zoom
- [ ] Overlay adjusts position near viewport edges
- [ ] Theme toggle updates overlay colors
- [ ] Visit data updates refresh overlay
