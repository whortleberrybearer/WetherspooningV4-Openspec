...
- [ ] Update component-local Pub interfaces
...
- [ ] Create display helper function or use inline fallback
...
- [ ] Update `PubLocationsMap.vue` info window display
...
- [ ] Update `PubSidebar.vue` pub list display
  - Apply same fallback pattern for country/region display
  - Verify list rendering with missing values

- [ ] Update `AppSidebar.vue` pub list display
  - Apply same fallback pattern for country/region display
  - Verify list rendering with missing values

- [ ] Update `PubDetailSheet.vue` pub detail display
  - Apply same fallback pattern for country/region display
